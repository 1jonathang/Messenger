// only allows props that an icon can take
// logo will be svg
...
// turns our icons into a "Logo" or "UserPlus" literal, gonna help if want to pass an icon as a prop, bc this is a function and u can't pass a function
// as a prop bw client and server components
